...
Defines how the CLI resolves a workspace root and persists the `ossify-cogents.json` config file: section-keyed reads/writes that round-trip unrecognized keys and write atomically.
